#!/usr/bin/env bash
# Sequentially run 4 ASR SASPG smoke experiments (100h, wav2vec2-base + hubert-large × str/unstr).
set -euo pipefail
...
export SASPG_REPO WORK_ROOT MAX_STEPS SMOKE_GPU_INDEX
...
echo ""
echo "========== ASR rotate done: fail=${_fail}/4 =========="
