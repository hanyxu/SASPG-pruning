...
# 模型权重文件路径
# MODEL_BIN_PATH = "/project_bdda8/bdda/hnxu/prune/SSLprune/hf_models/wav2vec2-base-100h/pytorch_model.bin"
MODEL_BIN_PATH = '/project_bdda9/bdda/hnxu/BayesianBits_clear/Hubert_large/ft/single_baseline_fp16_checkgradNo_freezeEnc_bs8x2_hubert_2e-4_20ep_28538/out/pytorch_model.bin'
# 保存掩码的根目录
BASE_OUTPUT_DIR = "./hubert_large_base_100h_masks"
