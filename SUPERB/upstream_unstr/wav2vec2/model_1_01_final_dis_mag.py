...
from . import components_1_01_final_dis_mag as components
# import components
...
class Wav2Vec2Model(Module):
    ...
    def prune(self, prune_ratio):
        ...
        conv_config, conv_out_index = self.feature_extractor.prune(prune_ratio)    # [(output_channel, kernel_size, stride), ...]
        transformer_config = self.encoder.prune(conv_out_index, prune_ratio)     # NOTE: this is a defaultdict(list)
