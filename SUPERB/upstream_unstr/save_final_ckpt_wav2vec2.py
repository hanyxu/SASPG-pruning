...
from prune_1_01 import load_pruned_model
...
if __name__ == "__main__":
    ...
    #     if "bias" in key.lower() or "weight" in key.lower():
    #         if value is not None and isinstance(value, torch.Tensor):
    #             print(f"Key: {key}, Shape: {value.shape}")
            
    out_path = args.ckpt_after_final_distill.parent / "pruned_wav2vec2_base.pth"
    torch.save(
        {
