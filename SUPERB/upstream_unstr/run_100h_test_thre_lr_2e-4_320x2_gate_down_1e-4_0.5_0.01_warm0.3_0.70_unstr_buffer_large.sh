...
gate_lr=1e-4             
target_sparsity=0.70347    # final target sparsity
...
python final_distill_1_01.py \
    ...
    --l1_weight ${l1_weight} \
    --cos_weight ${cos_weight} \
    --cos_type ${cos_type} 2>&1 | tee ${final_exp_dir}/final_distill_prune_true_1_01_test_1.log || exit 1;
