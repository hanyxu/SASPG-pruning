...
root_dir=exp/hubert-base_${train_subset}_sp${target_sparsity}_spup${sparsity_warmup}_lr${lr}_up${warmup}_max${max}_${distill_mode}${distill_layers}_reglr${reg_lr}_${pruning_units}_gate_norm_320s_repeat_50000steps_5_0.01_tau_1e-5_gate_accum2_1e-4_thre
