...
# python distill_1_01_lambda_reinit.py \
#     --tsv_dir ${tsv_dir} \
...
python final_distill.py \
    ...
    --l1_weight ${l1_weight} \
    --cos_weight ${cos_weight} \
    --cos_type ${cos_type} 2>&1 | tee ${final_exp_dir}/final_distill_true_prune_1_01.log || exit 1;
